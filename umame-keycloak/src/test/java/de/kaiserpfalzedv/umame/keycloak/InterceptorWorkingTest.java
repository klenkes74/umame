...
public class InterceptorWorkingTest {
    private InvocationContext INVOCATION_CONTEXT = new InvocationContext() {
        private InterceptedClass intercepted = new InterceptedClass();
    ...
    public void shouldRunWithoutException() throws Exception {
        tested.call("resource", "no-resource");
