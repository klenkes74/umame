 ...
 */
public class BaseUmameRuntimeExceptionTest {
    private static final Logger LOG = LoggerFactory.getLogger(BaseUmameRuntimeExceptionTest.class);

    private static final String MESSAGE = "message";
    private static final Exception CAUSE = new Exception("cause");

    private BaseUmameRuntimeException service;
    ...
    public void shouldAcceptConstructorWithOnlyMessage() {
        service = new BaseUmameRuntimeException(MESSAGE);
    ...
    public void setUpService() {
        service = new BaseUmameRuntimeException(MESSAGE, CAUSE);
    }
}
